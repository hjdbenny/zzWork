$(function() {
	...
	$.ajax({
		type: "POST",
		url: "http://wx.zzfco.com/wxmgmt/api/myMonthlyReport/listHistoryMonthlyReports/" + clientCode + ".do",
		async: false,
	...
	$(".save").click(e => {
		...
		$.ajax({
			type: "post",
			url: "http://wx.zzfco.com/wxmgmt/api/myMonthlyReport/saveOrUpdate.do",
			async: true,
			contentType: "application/json",
	...
	function loadData(reportId) {
		if(reportId != "") {
			$.ajax({
				type: "POST",
				url: `http://wx.zzfco.com/wxmgmt/api/myMonthlyReport/getMonthlyReport/${reportId}.do`,
				async: true,
				contentType: "application/json",
				success: function(data) {
