...
var app = new Vue({
	...
	created() {
//		//获取ClientCode
		axios.post('http://www.decaihui.com/wxweb/api/tempMsg/getClientCode.do', {}, {
				headers: {
			...
			.then((res) => {
				...
				//获取发送时间
				axios.post(`http://www.decaihui.com/wxweb/api/tempMsg/getSendDate/${$.getUrlParam("t")}.do`, {}, {
						headers: {
							"Content-Type": "application/json"
						}
					})
...
//						this.getData(1100583, "2018-01-29")
		...
		//记录打开
		axios.post(`http://www.decaihui.com/wxweb/api/tempMsg/recordOpenedTemplateMsg/${$.getUrlParam("t")}.do`, {}, {
				headers: {
					"Content-Type": "application/json"
				}
			})
	...
	methods: {
		...
		getRank: function(clientCode, today) { //获取排名
			axios.post('http://www.decaihui.com/wxweb/api/total/rankByType.do', {
