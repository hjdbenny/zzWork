...
function operation($scope, $http, $interval) {
	//页面载入默认
	loadData("http://www.decaihui.com/wxweb/api/total/position.do", 1, 1, "unclosed")
	...
	$(".closed").click(function() {
		...
		ajaxUrl = "http://www.decaihui.com/wxweb/api/total/closePosition.do"
	...
	$(".unclosed").click(function() {
		...
		$(".nav li").removeClass("select_on")
		$(this).addClass("select_on")
		ajaxUrl = "http://www.decaihui.com/wxweb/api/total/position.do"
	...
	function getUrl() {
		if($(".select_on").data("type") == "closed") {
			orderUrl = "http://www.decaihui.com/wxweb/api/total/closePosition.do"
		} else {
			orderUrl = "http://www.decaihui.com/wxweb/api/total/position.do"
		}
		return orderUrl;
	}
	...
	$.ajax({
		type: "POST",
		url: "http://www.decaihui.com/wxweb/api/total/stageProfit/" + sessionStorage.getItem("clientCode") + ".do",
		async: false,
		contentType: "application/json",
		success: function(data) {
			console.log(data)
	...
	function loadProfitData(dateType, type, order) {
		...
		$.ajax({
			type: "POST",
			url: "http://www.decaihui.com/wxweb/api/total/dailyProfitCurve.do",
			async: true,
