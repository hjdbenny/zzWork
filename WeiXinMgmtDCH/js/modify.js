...
function operation($scope, $http, $timeout, $http) {
	...
	$.ajax({
		type: "POST",
		url: "http://www.decaihui.com/wxmgmt/api/jyMonthlyReport/listMonthDates.do",
		async: true,
...
//			console.log(data)
			...
			$scope.shareAddress = "分享链接地址：http://www.decaihui.com/wxweb/index.html?date=" + $scope.shareDate
	...
	$scope.btn = function() {
		...
		$.ajax({
			type: "post",
			url: "http://www.decaihui.com/wxmgmt/api/jyMonthlyReport/saveOrUpdate.do",
			async: true,
			contentType: "application/json",
	...
	$scope.del = function() {
		...
		$.ajax({
			type: "post",
			url: "http://www.decaihui.com/wxmgmt/api/jyMonthlyReport/monthlyReport/delete.do",
			async: true,
			contentType: "application/json",
	...
	$scope.publish_first_next=function(){
		$.ajax({
			url:"http://www.decaihui.com:9091/weixin-service/wxapi/uploadMediaFile.do",
			type: 'POST',
			cache: false,
	...
	$scope.publish_second_next=function(){
		...
		var contentObj={
			...
			content_source_url:"http://www.decaihui.com/wxweb/index.html?date=" + $scope.shareDate,
		...
		$.ajax({
			type: "post",
			url:"http://www.decaihui.com/wxservice/wxapi/uploadMassSendNews.do",
			async: true,
			contentType: "application/json",
...
//			previewOpenId:"okHBNwyZhpQxsQXq0V82HgiXzRZM",
		...
		$.ajax({
			type: "post",
			url: "http://www.decaihui.com/wxservice/wxapi/sendMonthlyReport.do",
			async: true,
			contentType: "application/json",
...
//					console.log(JSON.parse(data.data.json))
	...
	var share_url = encodeURIComponent("http://www.decaihui.com/wxweb/index.html?date=" + $scope.shareDate);
	...
	function loadData(strDate) {
		$.ajax({
			type: "POST",
			url: "http://www.decaihui.com/wxmgmt/api/jyMonthlyReport/getMonthlyReport/" + strDate + ".do",
			contentType: "application/json",
			async: true,
			xhrFields: {
				withCredentials: true
